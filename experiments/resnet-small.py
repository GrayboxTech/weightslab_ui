...
class TinyResNet18(nn.Module):
    ...
    def __init__(
        ...
        # ---- 2) Stem ----
        # Adapt conv1 to arbitrary in_channels (e.g. 1 for MNIST)
        if in_channels != 3:
        ...
        # base.layer1 is a Sequential with 2 BasicBlocks in ResNet18
        # keep only layer1[0]:
        self.block1 = base.layer1[0]  # this is a BasicBlock(64 -> 64)
